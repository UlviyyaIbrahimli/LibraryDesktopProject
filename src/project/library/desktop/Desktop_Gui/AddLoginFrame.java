 ...
 * @Ulviyye Ibrahimli
 */
public class AddLoginFrame extends javax.swing.JFrame {
    ...
    AddLoginFrame(DepartmentService departmentService,
        ...
        roleCombo.setRenderer(new AddLoginFrame.TwoDecimalRenderer(roleCombo.getRenderer()));
        showRoleCombo();
    }
    ...
    private void initComponents() {
        ...
        lNameTxt.setForeground(new java.awt.Color(0, 51, 51));
        ...
        fNameTxt.setForeground(new java.awt.Color(0, 51, 51));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(minimizeBtn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    if ((!password.isEmpty()) && (!password.equals(" "))) {
                        if (password.length() > 5 && password.length() < 50) {
                            ...
                            if (!roleCombo.getSelectedItem().equals("Select Role")) {
                                ...
                                role.setId(roleId);
                                login.setRole(role);
                                boolean isAddLogin = loginService.addLogin(login);
                                if (isAddLogin) {
                                    JOptionPane.showMessageDialog(null, "Adding is Success");
                                    saveBtn.setEnabled(false);
                                } else {
                                    JOptionPane.showMessageDialog(null, "Adding is Fail!");
                                }
                            } else {
