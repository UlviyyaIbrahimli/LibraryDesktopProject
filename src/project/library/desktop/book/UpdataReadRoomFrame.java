 ...
 * @Ulviyye Ibrahimli
 */
public class UpdataReadRoomFrame extends javax.swing.JFrame {
    ...
    public UpdataReadRoomFrame() {
        initComponents();
    }

    UpdataReadRoomFrame(DepartmentService departmentService,
        ...
        try {
            ...
            initComponents();
            floorCombo.setRenderer(new UpdataReadRoomFrame.TwoDecimalRenderer(floorCombo.getRenderer()));
            this.setDefaultLookAndFeelDecorated(true);
            this.pack();
            this.setLocationRelativeTo(null);
            userTxt.setText("Welcome, " + login.getFirstName() + " " + login.getLastName() + " !");
            hideWarningLbl();
            ReadRoom readRoom = readRoomService.getReadRoomById(selectedId);
            showOldDate(readRoom);
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Update Read Room");
        ...
        roomNumberWLbl.setForeground(new java.awt.Color(204, 0, 0));
        ...
        chairCountWLbl.setForeground(new java.awt.Color(204, 0, 0));
        chairCountWLbl.setText("Numbeer Type");

        compCountLbl.setFont(new java.awt.Font("Times New Roman", 2, 14)); // NOI18N
        compCountLbl.setForeground(new java.awt.Color(204, 0, 0));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addComponent(compCountLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(15, 15, 15))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(roomNumberWLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(35, 35, 35)
                                        .addComponent(chairCountWLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(computerTxt, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 393, Short.MAX_VALUE)
                            .addComponent(chairCountTxt)
                            .addComponent(roomNumberTxt)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(floorCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(26, 26, 26))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        try {
            boolean isUpdateReadRoom = false;
            ...
            if ((readRoomNumber.matches("[a-zA-Z0-9 ]+")) && !(readRoomNumber.isEmpty())) {
                if (floorCombo.getSelectedIndex() > 0) {
                    ...
                    boolean check = checkReadRoomNumber(readRoomNumber, Integer.parseInt(floor));
                    if (check) {
                        ...
                        if (computerCount.matches("[0-9]+") && (!computerCount.isEmpty())) {
                            ...
                            if (chairCount.matches("[0-9]+") && (!chairCount.isEmpty())) {
                                ...
                                readRoom.setReadRoomNumber(readRoomNumber);
                                isUpdateReadRoom = readRoomService.updateReadRoom(readRoom, selectedId);
                                if (isUpdateReadRoom) {
                                    JOptionPane.showMessageDialog(null, "ADDING ID SUCCESS!", "SUCCESS", JOptionPane.INFORMATION_MESSAGE, new ImageIcon("C:\\Users\\user\\Desktop\\java/tick.png"));
    ...
    private void cancelBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelBtnActionPerformed
        this.dispose();
        BookItemFrame bookItemFrame = new BookItemFrame(departmentService, positionService, branchService, employeeService, timeTypeService, educationTypeService, bookService, authorService, subjectService, bookShelfService, bookRoomService, readRoomService, readTableService, languageService, readerService, orderInLibService, orderInHomeService, giveBackBookService, loginService, roleService, login);
        bookItemFrame.setVisible(true);    }//GEN-LAST:event_cancelBtnActionPerformed
    ...
    private void showOldDate(ReadRoom readRoom) {
        roomNumberTxt.setText(readRoom.getReadRoomNumber());
        floorCombo.setSelectedItem(String.valueOf(readRoom.getLibFloor()));
        if (readRoom.getComputerCount() != null) {
            computerTxt.setText(String.valueOf(readRoom.getComputerCount()));
        } else {
            computerTxt.setText("0");
        }
        if (readRoom.getChairCount() != null) {
            chairCountTxt.setText(String.valueOf(readRoom.getChairCount()));
        } else {
            chairCountTxt.setText("0");
        }
    ...
    boolean checkReadRoomNumber(String number, int floor) {
        boolean result = true;
        try {
            List<ReadRoom> rooms = readRoomService.getReadRoomByRoomFloor(floor);
            ReadRoom readRoom = readRoomService.getReadRoomById(selectedId);
            if (!readRoom.getReadRoomNumber().equals(number)) {
