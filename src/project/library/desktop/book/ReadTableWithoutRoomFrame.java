 ...
 * @ Ulviyye Ibrahimli
 */
public class ReadTableWithoutRoomFrame extends javax.swing.JFrame {
    ...
    public ReadTableWithoutRoomFrame() {
        initComponents();
    }

    ReadTableWithoutRoomFrame(DepartmentService departmentService,
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NON ROOM READER-TABLE");
        ...
        if (selectedRow != -1) {
            if (table.getSelectedRowCount() == 1) {
                ...
                if (choose == JOptionPane.YES_OPTION) {
                    try {
                        boolean isDeleteBook = readTableService.deleteReadTable(id);
                        if (isDeleteBook) {
