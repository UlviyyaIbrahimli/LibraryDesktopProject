 ...
 * @Ulviyye Ibrahimli
 */
public class BookWithoutShelfFrame extends javax.swing.JFrame {
    ...
    public BookWithoutShelfFrame() {
        initComponents();
    }

    BookWithoutShelfFrame(DepartmentService departmentService,
        ...
        showBooksWithotShelf(selectedId);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NON-SHELF BOOKS");
    ...
    private void showBooksWithotShelf(Long id) {
        try {
            ...
            List<BookShelf> bookList = bookShelfService.getBookByShelfId(id);
            model.addColumn("Id");
            model.addColumn("№");
            ...
            for (BookShelf book : bookList) {
                Object object[] = new Object[]{
                    book.getBook().getId(), book.getBook().getNumber(),
